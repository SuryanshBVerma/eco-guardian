...
```bash
npx -y github:boredom1234/eco-guardian --path . --ecosystems scan-all --write-baseline .eco-guardian-baseline.json --banner off; status=$?; echo "eco-guardian exit code: $status"; exit 0
```
