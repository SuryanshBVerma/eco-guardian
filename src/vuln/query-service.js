...
/**
 * Queries OSV (and NVD for Java ecosystems) for vulnerabilities in the given packages.
 * Handles caching, batching, retries, and cross-source deduplication.
 *
 * @param {Map} packageMap - Packages keyed by ecosystem|name|version.
 * @param {object} options - Parsed CLI options.
 * @returns {Promise<object>} Vulnerability map with optional __diagnostics property.
 */
